...
#import <CGAuthorKit_Category/CTMediator+Author.h>
...
//        UIImage *placehodlerPicture = [UIImage ff_imagePathWithName:@"placehodler" bundle:@"FFSpecialKit" targetClass:[self class]];
//        UIImage *placehodlerHeader = [UIImage ff_imagePathWithName:@"pc_default_avatar" bundle:@"FFSpecialKit" targetClass:[self class]];
//        [self.pictureView yy_setImageWithURL:data[kSpecialPropertyListKeyPictureURL] placeholder:placehodlerPicture];
//        [self.headImgView yy_setImageWithURL:author[kAuthorPropertyListHeaderURL] placeholder:placehodlerHeader];
//        
