...
- (UIButton *)createBtn:(NSString *)imageName{
    ...
    NSString *name = [NSString ff_imagePathWithName:imageName bundle:@"FFSpecialKit" targetClass:[self class]];
    [btn title:nil titleColor:kHexColor_555 image:name backgroundColor:nil fontSize:FONT_SIZE_12 target:nil action:nil];
    [btn sizeToFit];
